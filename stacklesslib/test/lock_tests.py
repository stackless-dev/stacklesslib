...
# compute time.time() granularity
# measurements here are done with this, whereas scheduling uses time.clock()
# so we need to adjust for the added precision of the scheduling.
t0 = time.time()
while True:
    t1 = time.time()
    if t1 != t0:
